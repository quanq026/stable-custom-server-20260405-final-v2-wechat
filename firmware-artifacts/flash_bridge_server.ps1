...
$sdkconfigDefaults = "sdkconfig.defaults;sdkconfig.defaults.esp32s3;sdkconfig.defaults.bridge"
...
try {
    $sdkconfigFile = Join-Path $projectRoot "sdkconfig.bridge"
