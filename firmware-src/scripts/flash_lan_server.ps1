...
$sdkconfigDefaults = "sdkconfig.defaults;sdkconfig.defaults.esp32s3;sdkconfig.defaults.lan"
...
try {
    $sdkconfigFile = Join-Path $projectRoot "sdkconfig.lan"
